...
void BookmarkTreeView::CreateNewFolder()
{
	...
	auto selectedFolder = GetBookmarkFolderFromTreeView(selectedItem);
	CreateNewFolder(selectedFolder);
}

void BookmarkTreeView::CreateNewFolder(BookmarkItem *parentFolder)
{
