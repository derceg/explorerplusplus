...
void TaskbarThumbnails::Initialize()
{
	...
	m_tabContainer->tabNavigationStartedSignal.AddObserver(
		boost::bind(&TaskbarThumbnails::OnNavigationStarted, this, _1, _2, _3));
	...
	HWND hwnd, UINT Msg, WPARAM wParam, LPARAM lParam, int iTabId)
{
	...
	case WM_DWMSENDICONICLIVEPREVIEWBITMAP:
	{
		...
		else
		{
			...
			MapWindowPoints(tab->GetShellBrowser()->GetListView(), m_expp->GetMainWindow(),
...
void TaskbarThumbnails::OnNavigationStarted(
