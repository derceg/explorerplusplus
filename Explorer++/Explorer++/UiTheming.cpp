...
{
	m_connections.emplace_back(m_tabContainer->tabCreatedSignal.AddObserver(boost::bind(
		&UiTheming::OnTabCreated, this, boost::placeholders::_1, boost::placeholders::_2)));
}
