...
#define WM_USER_UPDATEWINDOWS		(WM_USER + 17)
#define WM_USER_FILESADDED			(WM_USER + 51)
#define WM_USER_RELEASEBROWSER		(WM_USER + 52)
#define WM_USER_STARTEDBROWSING		(WM_USER + 55)
#define WM_USER_NEWITEMINSERTED		(WM_USER + 200)
#define WM_USER_FOLDEREMPTY			(WM_USER + 201)
#define WM_USER_FILTERINGAPPLIED	(WM_USER + 202)
#define WM_USER_GETCOLUMNNAMEINDEX	(WM_USER + 203)
#define WM_USER_DIRECTORYMODIFIED	(WM_USER + 204)
